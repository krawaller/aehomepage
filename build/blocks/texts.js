exports.texts = {
	en: {
		...
		"$TAGLINE": "The love child between<br/>a math text book and<br/>a symbolic calculator",
		"$VIDEOLINK": "Mw_1dKThAtI",
		"$CONTACTHEADLINE": "Contact",
		"$MD_CONTACT": "For questions or feedback, [visit us on Facebook](http://facebook.com/algebraexplorer) or [send an email](mailto:david@krawaller.se)!",
	...
	sv: {
		...
		"$TAGLINE": "Kärleksbarnet mellan<br/>en mattebok och en<br/>symbolhanterande miniräknare",
		"$VIDEOLINK": "LHiuBx9sbmw",
		"$CONTACTHEADLINE": "Kontakt",
		"$MD_CONTACT": "För frågor eller feedback, [besök oss på Facebook](http://facebook.com/algebraexplorer) eller [skicka ett mail](mailto:david@krawaller.se)!",
