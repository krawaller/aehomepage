exports.texts = {
	en: {
		"$FACEBOOKLANG": "en_US",
		"$RUNHEADLINE": "Run in the browser",
		...
		"$DEMOHEADLINE": "Demo video",
		"$TAGLINE": "The love child of<br/>a math text book and<br/>a symbolic calculator",
		"$VIDEOLINK": "Mw_1dKThAtI",
		"$CONTACTHEADLINE": "Contact",
		"$MD_CONTACT": "For questions or feedback, [visit us on Facebook](http://facebook.com/algebraexplorer) or [send an email](mailto:david@krawaller.se)! There is also a reporting tool inside the app which provides additional debugging info for us if you use it.",
	...
	sv: {
		...
		"$VIDEOLINK": "LHiuBx9sbmw",
		"$CONTACTHEADLINE": "Kontakt",
		"$MD_CONTACT": "För frågor eller feedback, [besök oss på Facebook](http://facebook.com/algebraexplorer) eller [skicka ett mail](mailto:david@krawaller.se)! Det finns också ett rapporteringsverktyg inuti appen som ger oss ytterligare data som hjälp att reda ut det hela när du råkar ut för fel.",
